...
import { HomeIcon, BuildingIcon } from '../icons';

const navItems = [
  { to: '/super/dashboard', label: 'Dashboard', Icon: HomeIcon },
  { to: '/negocios', label: 'Negocios', Icon: BuildingIcon },
];
  ...
  return (
    <aside className="hidden md:flex w-64 flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
      <div className="h-16 flex items-center justify-center border-b border-gray-200 dark:border-gray-700">
        <h1 className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">Super Panel</h1>
      </div>
